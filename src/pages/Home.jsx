import { ShoppingBag, Truck, Shield, Headphones, Star, ChevronLeft, ChevronRight, TrendingUp, Sparkles, MessageSquare, MessageCircle, Facebook, Twitter } from 'lucide-react';
...
export default function Home({ isAuthenticated, setIsAuthenticated }) {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400 text-sm mb-4">Your trusted partner in business technology solutions.</p>
              <div className="flex space-x-4">
                <a href="https://www.facebook.com/people/Atlas-and-Arrow-Solutions/100063543311394/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                </a>
                <a href="https://x.com/distroyer_1644" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                </a>
                <a href="https://wa.me/918423267608" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400 text-sm">
                ...
                <li><a href="mailto:sales@atlasandarrow.in" className="hover:text-white transition">sales@atlasandarrow.in</a></li>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-500 text-sm">
            <p>&copy; 2025. All rights are reserved by <a href="https://atlasarrow.me" className="text-gray-400 hover:text-white">atlasarrow.me</a></p>
          </div>
        </div>
      </footer>
      ...
      <a
        href="https://wa.me/918423267608?text=Hi%20Atlas%20and%20Arrow!%20I%20have%20a%20query."
        target="_blank"
